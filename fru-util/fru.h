...
#define	EEPROM_CHASSIS_ADDRESS	0x008
#define	EEPROM_BOARD_ADDRESS	0x60
#define	EEPROM_PRODUCT_ADDRESS	0xD8
#define	EEPROM_MULTIRECORD_ADDRESS	0x158

/* Info area size */
#define CHASSIS_AREA_SIZE (EEPROM_BOARD_ADDRESS - EEPROM_CHASSIS_ADDRESS)
#define BOARD_AREA_SIZE (EEPROM_PRODUCT_ADDRESS - EEPROM_BOARD_ADDRESS)
#define PRODUCT_AREA_SIZE (EEPROM_MULTIRECORD_ADDRESS - EEPROM_PRODUCT_ADDRESS)
#define MULTIRECORD_AREA_SIZE 0x100
